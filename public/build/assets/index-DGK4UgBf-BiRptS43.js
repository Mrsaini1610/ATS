import{c as Un}from"./createLucideIcon-BZ0u6yUi.js";/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function w(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function qn(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(w())}function Gn(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Bt(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Jn(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Ht(){try{return typeof indexedDB=="object"}catch{return!1}}function zt(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var s;e(((s=i.error)==null?void 0:s.message)||"")}}catch(n){e(n)}})}function Yn(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wt(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}class b{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R=new He("@firebase/app"),vr="@firebase/app-compat",Cr="@firebase/analytics-compat",Rr="@firebase/analytics",Pr="@firebase/app-check-compat",kr="@firebase/app-check",Nr="@firebase/auth",Dr="@firebase/auth-compat",Or="@firebase/database",Lr="@firebase/data-connect",Mr="@firebase/database-compat",Ur="@firebase/functions",Fr="@firebase/functions-compat",$r="@firebase/installations",Vr="@firebase/installations-compat",xr="@firebase/messaging",Br="@firebase/messaging-compat",Hr="@firebase/performance",zr="@firebase/performance-compat",Wr="@firebase/remote-config",jr="@firebase/remote-config-compat",Kr="@firebase/storage",qr="@firebase/storage-compat",Gr="@firebase/firestore",Jr="@firebase/ai",Yr="@firebase/firestore-compat",Xr="firebase",Qr="12.17.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me="[DEFAULT]",Zr={[Le]:"fire-core",[vr]:"fire-core-compat",[Rr]:"fire-analytics",[Cr]:"fire-analytics-compat",[kr]:"fire-app-check",[Pr]:"fire-app-check-compat",[Nr]:"fire-auth",[Dr]:"fire-auth-compat",[Or]:"fire-rtdb",[Lr]:"fire-data-connect",[Mr]:"fire-rtdb-compat",[Ur]:"fire-fn",[Fr]:"fire-fn-compat",[$r]:"fire-iid",[Vr]:"fire-iid-compat",[xr]:"fire-fcm",[Br]:"fire-fcm-compat",[Hr]:"fire-perf",[zr]:"fire-perf-compat",[Wr]:"fire-rc",[jr]:"fire-rc-compat",[Kr]:"fire-gcs",[qr]:"fire-gcs-compat",[Gr]:"fire-fst",[Yr]:"fire-fst-compat",[Jr]:"fire-vertex","fire-js":"fire-js",[Xr]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ii="firebase-heartbeat-database",si=1,Z="firebase-heartbeat-store";let Ee=null;function Jt(){return Ee||(Ee=qt(ii,si,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Z)}catch(n){console.warn(n)}}}}).catch(t=>{throw v.create("idb-open",{originalErrorMessage:t.message})})),Ee}async function ai(t){try{const n=(await Jt()).transaction(Z),r=await n.objectStore(Z).get(Yt(t));return await n.done,r}catch(e){if(e instanceof E)R.warn(e.message);else{const n=v.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});R.warn(n.message)}}}async function ct(t,e){try{const r=(await Jt()).transaction(Z,"readwrite");await r.objectStore(Z).put(e,Yt(t)),await r.done}catch(n){if(n instanceof E)R.warn(n.message);else{const r=v.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});R.warn(r.message)}}}function Yt(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ge(t,e=!1){let n;const r=await me(t.appConfig,s=>{if(!pn(s))throw $.create("not-registered");const a=s.authToken;if(!e&&zi(a))return s;if(a.requestStatus===1)return n=Bi(t,e),s;{if(!navigator.onLine)throw $.create("app-offline");const o=ji(s);return n=Hi(t,o),o}});return n?await n:r.authToken}async function Bi(t,e){let n=await dt(t.appConfig);for(;n.authToken.requestStatus===1;)await cn(100),n=await dt(t.appConfig);const r=n.authToken;return r.requestStatus===0?Ge(t,e):r}function dt(t){return me(t,e=>{if(!pn(e))throw $.create("not-registered");const n=e.authToken;return Ki(n)?{...e,authToken:{requestStatus:0}}:e})}async function Hi(t,e){try{const n=await Vi(t,e),r={...e,authToken:n};return await se(t.appConfig,r),n}catch(n){if(tn(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await dn(t.appConfig);else{const r={...e,authToken:{requestStatus:0}};await se(t.appConfig,r)}throw n}}function pn(t){return t!==void 0&&t.registrationStatus===2}function zi(t){return t.requestStatus===2&&!Wi(t)}function Wi(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+Ii}function ji(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function Ki(t){return t.requestStatus===1&&t.requestTime+Qt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qi(t){const e=t,{installationEntry:n,registrationPromise:r}=await qe(e);return r?r.catch(console.error):Ge(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gi(t,e=!1){const n=t;return await Ji(n),(await Ge(n,e)).token}async function Ji(t){const{registrationPromise:e}=await qe(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn="installations",Xi="installations-internal",Qi=t=>{const e=t.getProvider("app").getImmediate(),n=Yi(e),r=fe(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Zi=t=>{const e=t.getProvider("app").getImmediate(),n=fe(e,mn).getImmediate();return{getId:()=>qi(n),getToken:i=>Gi(n,i)}};function es(){P(new b(mn,Qi,"PUBLIC")),P(new b(Xi,Zi,"PRIVATE"))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oe=new He("@firebase/auth");function Vs(t,...e){oe.logLevel<=f.WARN&&oe.warn(`Auth (${We}): ${t}`,...e)}function ne(t,...e){oe.logLevel<=f.ERROR&&oe.error(`Auth (${We}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ee{constructor(e,n){this.shortDelay=e,this.longDelay=n,ce(n>e,"Short delay should be less than long delay!"),this.isMobile=qn()||Jn()}get(){return xs()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ws=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],js=new ee(3e4,6e4);function k(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function T(t,e,n,r,i={}){return An(t,i,async()=>{let s={},a={};r&&(e==="GET"?a=r:s={body:JSON.stringify(r)});const o=Be({...a,key:t.config.apiKey}).slice(1),c=await t._getAdditionalHeaders();c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode);const l={method:e,headers:c,...s};return Gn()||(l.referrerPolicy="strict-origin-when-cross-origin"),t.emulatorConfig&&Wt(t.emulatorConfig.host)&&(l.credentials="include"),Sn.fetch()(await vn(t,t.config.apiHost,n,o),l)})}async function An(t,e,n){t._canInitEmulator=!1;const r={...zs,...e};try{const i=new qs(t),s=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const a=await s.json();if("needConfirmation"in a)throw G(t,"account-exists-with-different-credential",a);if(s.ok&&!("errorMessage"in a))return a;{const o=s.ok?a.errorMessage:a.error.message,[c,l]=o.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw G(t,"credential-already-in-use",a);if(c==="EMAIL_EXISTS")throw G(t,"email-already-in-use",a);if(c==="USER_DISABLED")throw G(t,"user-disabled",a);const u=r[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw En(t,u,l);$e(t,u)}}catch(i){if(i instanceof E)throw i;$e(t,"network-request-failed",{message:String(i)})}}async function Qe(t,e,n,r,i={}){const s=await T(t,e,n,r,i);return"mfaPendingCredential"in s&&$e(t,"multi-factor-auth-required",{_serverResponse:s}),s}async function vn(t,e,n,r){const i=`${e}${n}?${r}`,s=t,a=s.config.emulator?Hs(t.config,i):`${t.config.apiScheme}://${i}`;return Ws.includes(n)&&(await s._persistenceManagerAvailable,s._getPersistenceType()==="COOKIE")?s._getPersistence()._getFinalTarget(a).toString():a}function Ks(t){switch(t){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class qs{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(H(this.auth,"network-request-failed")),js.get())})}}function G(t,e,n){const r={appName:t.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=H(t,e,r);return i.customData._tokenResponse=n,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gs(t){return(await T(t,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function Rn(t,e){return T(t,"GET","/v2/recaptchaConfig",k(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){h(e.idToken,"internal-error"),h(typeof e.idToken<"u","internal-error"),h(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Et(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){h(e.length!==0,"internal-error");const n=Et(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(h(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await ta(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,a=new W;return r&&(h(typeof r=="string","internal-error",{appName:e}),a.refreshToken=r),i&&(h(typeof i=="string","internal-error",{appName:e}),a.accessToken=i),s&&(h(typeof s=="number","internal-error",{appName:e}),a.expirationTime=s),a}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new W,this.toJSON())}_performRefresh(){return C("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dn(t,e=[]){let n;switch(t){case"Browser":n=At(w());break;case"Worker":n=`${At(w())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${We}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ma(t,e,n=!1){if(D(t.app))return Promise.reject(z(t));const r="signIn",i=await La(t,r,e),s=await ue._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function Ua(t,e){return Ma(K(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qa(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ga(t){P(new b("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:a,authDomain:o}=r.options;h(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const c={apiKey:a,authDomain:o,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Dn(t)},l=new pa(r,i,s,c);return Ra(l,n),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),P(new b("auth-internal",e=>{const n=K(e.getProvider("auth").getImmediate());return(r=>new Ka(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),_(Dt,Ot,qa(t)),_(Dt,Ot,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
