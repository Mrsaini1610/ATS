            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-10">
                  ...
                  <div>
                    ...
                    <div className="text-blue-200 text-xs">India's #1 Job Platform</div>
                  </div>
                </div>

                <h2 className="text-white text-3xl font-bold leading-tight mb-3">
                  Your Dream Job <br /> Is One Step Away
                </h2>
                <p className="text-blue-100 text-sm leading-relaxed max-w-sm">
                  India ke top employers se directly connect karo. Apni skills ke mutabiq best opportunities dhundo.
                </p>
              </div>
              ...
              <div className="relative z-10 space-y-3 my-8">
                {floatingJobs.map((job, i) => (
                  ...
                  >
                    <div className={`w-9 h-9 ${job.color} rounded-xl flex items-center justify-center shrink-0`}>
                    ...
                    <span className="text-green-300 text-xs font-medium shrink-0">{job.salary}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="relative z-10">
                <div className="grid grid-cols-4 gap-3 mb-6">
                  {stats.map((s) => (
                    <div key={s.label} className="text-center bg-white/10 backdrop-blur-sm rounded-xl py-3">
                ...
                <div className="space-y-2">
                  {features.map((f) => (
                    <div key={f.text} className="flex items-center gap-2.5 text-blue-100 text-sm">
