                            ...
                            <div className="flex h-16 justify-between border-gray-200 dark:border-gray-700">
                                ...
                                <div className="hidden sm:ms-6 sm:flex sm:items-center gap-2 relative">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 bg-gray-200 dark:bg-gray-700 px-4 py-2 rounded-xl text-sm hover:bg-gray-300 dark:hover:bg-gray-600 transition hidden md:flex"
                                    >
                                        {darkMode ? (
                                    ...
                                    {/* Button for setting */}
                                    <div className='flex items-center gap-2 bg-gray-200 dark:bg-gray-700 px-4 py-2 rounded-xl text-xl text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition cursor-pointer md:flex hidden'>
                                        <IoSettings />
                                    </div>
                                </div>
                                ...
                                <div className="-me-2 flex items-center sm:hidden gap-2">
                                    <div className='flex items-center gap-2 bg-gray-200 dark:bg-gray-700 px-1 rounded-xl text-xl text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition cursor-pointer'>
                                        {/* Empty div - can add mobile menu items here */}
                                    </div>
